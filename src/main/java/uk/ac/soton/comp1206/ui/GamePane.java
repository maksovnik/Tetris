...
/**
 * The Game Pane is a special pane which will scale anything inside it to the
 * screen and maintain the aspect ratio.
 *
 * Drawing will be scaled appropriately.
 *
 * This takes the worry about the layout out and will allow the game to scale to
 * any resolution easily.
 *
 * It uses the width and height given which should match the main window size.
 * This will be the base drawing resolution, but will be scaled up or down as
...
public class GamePane extends StackPane {
    ...
    /**
     * Use a Graphics Transformation to scale everything inside this pane. Padding
     * is added to the edges to maintain the correct aspect ratio and keep the
     * display centred.
     */
    @Override
